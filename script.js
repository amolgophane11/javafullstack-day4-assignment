// question-1: compare two object
let obj1={name:"Amol",age:"25"}
let obj2={age:"25",name:"Amol"}

// using lodash method we can compare two object with same properties
//  and different order
console.log(_.isEqual(obj1,obj2));

Object.keys(all).forEach(key =>{
    console.log(key,all[key].flag)
})
//output: true


// question 2: print the flag of all------------------------------------
...
Object.keys(all).forEach(key =>{
    console.log(`${all[key].name}:${all[key].flag}`)
    });
...
//Question:3 using same countires print the nam,region,subregion and population--------------------------

Object.keys(all).forEach(key =>{
    console.log(key,all[key].name);
    console.log(all[key].region);
    console.log(all[key].subregion);
    console.log(all[key].population);
    console.log("/====================/")
           });
...
2302
/====================/
165 Korea (Democratic People's Republic of)
Asia
Eastern Asia
25778815
/====================/
